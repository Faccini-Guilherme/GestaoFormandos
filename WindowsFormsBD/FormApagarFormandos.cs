...
namespace WindowsFormsBD
{
    public partial class FormApagarFormandos : Form
    {
        ...
        private void FormApagarFormandos_Load(object sender, EventArgs e)
        {
            ...
            ligacao.SelecionarNacionalidade(ref cmbNacionalidade, id_nacionalidade);
        }
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            ...
            if (ligacao.PesquisaFormando(nudID.Value.ToString(), ref nome, ref morada, ref contacto,
                ref iban, ref genero, ref data_nascimento, ref nacionalidade))
            {
                txtNome.Text = nome;
                ...
                ligacao.SelecionarNacionalidade(ref cmbNacionalidade, nacionalidade);
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            //É emitido a mensagem se foi elimado com sucesso ou não
